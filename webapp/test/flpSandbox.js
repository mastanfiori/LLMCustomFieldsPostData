		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comnttdatalakeshorer300poconfirmation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttdatalakeshorer300poconfirmation-display": {
								"semanticObject": "comnttdatalakeshorer300poconfirmation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nttdata.lakeshore.r300poconfirmation",
									"url": sap.ui.require.toUrl("com/nttdata/lakeshore/r300poconfirmation")
								}
							}
						}
					}
